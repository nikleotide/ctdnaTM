...
#' @seealso \code{\link{TSG_Tier2}}, \code{\link{ctdna_variant_filter}}.
#' @examples
#' \dontrun{
#' df_filt <- ctdna_variant_filter(df, filter_scheme = "HRR14")
#' # or directly:
#' mask <- ctdnaTM:::.eval_rule(HRR14(), df)
#' }
#' @rdname ctdna_rules_library
#' @export
...
#' head(prep$filter_explanation$HRR14$filtering_criteria)
#' @export
HRR14 <- function() {
...
#'     excluded -- they belong to \code{HRR14}).
#'   \item Drop benign-annotated calls.
#'   \item Drop CHIP variants.
...
#'
#' @return A \code{ctdna_filtering_scheme} object.
#' @seealso \code{\link{HRR14}}, \code{\link{ctdna_variant_filter}}.
#' @examples
#' \dontrun{
#' df_filt <- ctdna_variant_filter(df, filter_scheme = "TSG_Tier2")
#' }
#' @rdname ctdna_rules_library
#' @export
...
#' @seealso \code{\link{TSG_Tier2}}, \code{\link{HRR14}},
#'   \code{\link{ctdna_variant_filter}}.
#' @examples
#' sim  <- ctdna_make_mock_study(n_patients = 30, seed = 1)
#' prep <- ctdna_prepare(infinity_report = sim$infinity_report,
...
#'                              apply = TRUE, explain = TRUE, verbose = FALSE)
#' head(prep$filter_explanation$TSG_Tier1$filtering_criteria)
#' @export
TSG_Tier1 <- function() {
...
#' @seealso \code{\link{TSG_Tier1}}, \code{\link{HRR14}},
#'   \code{\link{ctdna_variant_filter}}.
#' @examples
#' sim  <- ctdna_make_mock_study(n_patients = 30, seed = 1)
#' prep <- ctdna_prepare(infinity_report = sim$infinity_report,
...
#' @seealso \code{\link{TSG_Tier1}}, \code{\link{TSG_Tier2}},
#'   \code{\link{HRR14}}, \code{\link{ctdna_variant_filter}}.
#' @examples
#' sim  <- ctdna_make_mock_study(n_patients = 30, seed = 1)
#' prep <- ctdna_prepare(infinity_report = sim$infinity_report,
#'                       adam = list(adsl = sim$clinical), verbose = FALSE)
...
#'                              apply = TRUE, explain = TRUE, verbose = FALSE)
#' head(prep$filter_explanation$TSG_Tier3$filtering_criteria)
#' @export
TSG_Tier3 <- function() {
...
#' @return A \code{ctdna_filtering_scheme} object.
#' @seealso \code{\link{HRR14}}, \code{\link{TSG_Tier2}},
#'   \code{\link{ctdna_variant_filter}}.
#' @rdname ctdna_rules_library
#' @export
