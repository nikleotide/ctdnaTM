...
#
# Example output for scheme_HRR():
#
#   scheme_HRR  (category: gene_set)
...
#' @examples
#' \dontrun{
#' visualized_scheme("scheme_HRR")
#' visualized_scheme("scheme_TSG")
#'
...
#' lines <- visualized_scheme("scheme_HRR", print = FALSE)
#' writeLines(lines, "scheme_HRR.txt")
#' }
#' @export
